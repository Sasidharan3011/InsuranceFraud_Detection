...
@cross_origin() # route with allowed methods as POST and GET
def index():
        ...
        try:
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                flipkart_html = bs(flipkartPage, "html.parser") # parsing the webpage as HTML
                 bigboxes=bes.find_all('div', {"class": "bhgxx2 col-12-12"}) # seacrhing for appropriate tag to redirect to the product link
